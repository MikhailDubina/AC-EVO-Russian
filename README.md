...
**Статус перевода:** переведено **около 30%** строк локализации (более 550 ключей с русским текстом). Охвачены все основные экраны: главное меню, настройки гонки и ассистов, погода и трасса, профиль пилота, настройки управления/звука/видео, диалоги и подсказки. Оставшиеся строки — часть служебных сообщений, названий и текстов, до которых перевод будет дополняться.
...
- **Диалоги:** выход из игры («Вы уверены, что хотите выйти из игры?»)
