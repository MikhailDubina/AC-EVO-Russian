...
**Если папки `uiresources` вообще нет или она пустая:** это файлы игры (~1 ГБ), мы их раздавать не можем. Обязательно в Steam: «Проверить целостность файлов игры» — Steam восстановит недостающие файлы. После этого снова запустите `install_ru.bat`.
