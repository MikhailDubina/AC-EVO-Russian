...
2. **Запустите `install_ru.bat`** — скрипт автоматически найдёт игру в стандартной папке Steam, скопирует файлы переводов и применит патч меню игры. Если игра в другом месте — введите путь по запросу. Запуск от имени администратора не нужен.
